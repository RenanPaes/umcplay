    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          ...
          <!--Modificação Toogle-->
          <li>
            <a class="nav" id="entrar" data-target="#" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Entrar</a>
          ...
          <div class="wow bounceInUp" data-wow-delay="0.2s">
            <div class="team boxed-grey">
              <div class="inner">
                ...
                <a href="login.php"class="subtitle">Ouça Agora...</a><br><br>
